...
class TextBlock(object):
    ...
    def __init__(self, 
                 ...
                 bubble_boxes: List = None,
                 text_blocks_bboxes: List = None,
                 text_type: str = "",
                 inpaint_bboxes = None,
                 lines: List = None,
        ...
        self.text_bbox = text_bbox  # Store the text bounding box
        self.text_blocks_bboxes = text_blocks_bboxes  # Store the text blocks bounding boxes
        self.bubble_boxes = bubble_boxes  # Store the bubble boxes
        self.text_type = text_type  # Store the text type (e.g., "dialog", "narration", etc.)
        
        # Keep existing attributes
        self.xyxy = text_bbox
        self.segm_pts = text_segm_points
        self.bubble_xyxy = bubble_boxes[0][0] if bubble_boxes and len(bubble_boxes) > 0 else None
        self.text_class = text_type
